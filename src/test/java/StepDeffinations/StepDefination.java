	    ...
	    static Properties prop=propfile.propertyfile();
	         ...
	         @Given("^Navigate to the Application$")
	            public void navigate_to_the_Application() throws Throwable {
	    		 ...
	    		 {
	    			  System.out.println("Enter a valid driver detail (1:For Chrome 2:For FireFox)");
	    		 } 
	               
	                driver.manage().timeouts().implicitlyWait(15, TimeUnit.SECONDS);
	                driver.get(prop.getProperty("url"));
	              //driver.get("https://qualitypointtech.net/timesheetdemo/index.php");
	                String actualTitle = driver.getTitle();
	        		driver.manage().window().maximize();
	        		String expectedTitle = "Online Timesheet • Qualitypointtech.com";
